...
- Dockerized application delivery and container runtime optimization
- Infrastructure as Code with Terraform-style workflows
- CI/CD pipelines using Jenkins and GitHub Actions
- Linux server automation, Nginx, SSL/TLS, logs, and runtime troubleshooting
- Production deployment runbooks, monitoring, reliability, and release discipline
...
| Workly | HRMS SaaS deployment workflows and runtime support | [workly.wenawa.com](https://workly.wenawa.com) |
| HealthTune | Application delivery, deployment support, runtime reliability | [app.healthtune.io](https://app.healthtune.io) |
| Veritag Cloud | Cloud product infrastructure and deployment maintenance | [veritag.cloud](https://veritag.cloud) |
...
```txt
cloud_runtime      AWS, Linux, Nginx, SSL/TLS
containers         Docker, Kubernetes, registries, rollouts
automation         Terraform, Jenkins, GitHub Actions, CI/CD
reliability        monitoring, backups, logs, runbooks
